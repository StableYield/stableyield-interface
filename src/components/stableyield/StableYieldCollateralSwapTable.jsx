...
import styles from "./StableYieldCollateralSwapTable.module.css";
...
/**
 * @name StableYieldCollateralSwapTable
 * @param {Object} props
 */
export const StableYieldCollateralSwapTable = ({ address, ...props }) => {
...
export default StableYieldCollateralSwapTable;
